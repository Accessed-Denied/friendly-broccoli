...
extension UIImageView
{
    ...
    func downloadCachedImage(placeholder: String,urlString: String){
        if #available(iOS 13.0, *) {
            self.sainiShowLoader(loaderColor: .systemBackground)
        } else {
            // Fallback on earlier versions
            self.sainiShowLoader(loaderColor: #colorLiteral(red: 1, green: 0.4520469308, blue: 0.2609457374, alpha: 1))
        }
...
extension UIView{
    ...
    //MARK:- sainiBlur
    func sainiBlur(style: UIBlurEffect.Style){
    ...
    func sainiGradientColor(colorArr: [CGColor],vertical: Bool){
    ...
    func sainiCornerRadius(radius: CGFloat){
    ...
    //MARK:- sainiShadow
    func sainiShadow(shadowColor: CGColor,shadowOpacity: Float,shadowRadius:CGFloat){
    ...
    func sainiShadowWithCornerRadius(shadowColor: CGColor,shadowOpacity: Float,shadowRadius:CGFloat,cornerRadius: CGFloat){
        self.layer.shadowColor = shadowColor
        self.layer.shadowOpacity = shadowOpacity
        self.layer.shadowOffset = .zero
        self.layer.shadowRadius = shadowRadius
    ...
    func sainiGrowAndShrink(startValue: Float,endValue: Float,duration:CFTimeInterval){
    ...
    //MARK:- sainiRotate
    func sainiRotate(duration: Double = 1,isForward: Bool = true) {
    ...
    func sainiAddBorderWithColor(color:UIColor, edge:AIEdge, thicknessOfBorder:CGFloat)  {
    ...
    func sainiDrawDashedBorderAroundView(dashColor: UIColor,dashWidth: CGFloat) {
    ...
    func sainiRotateByAngle(angle: CGFloat) {
    ...
    func sainiDashedLine(color: CGColor,lineDashPattern: [NSNumber]) {
    ...
    //MARK:- sainiShowToast
    func sainiShowToast(message: String) {
    ...
    func sainiPlayVideoInBackground(fileName: URL){
